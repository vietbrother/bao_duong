...
public class RepairLaborMngtUI extends CustomComponent {
    ...
    public RepairLaborMngtUI(String caption) {
...
//        detailsWrapper.addStyleName(ValoTheme.TABSHEET_CENTERED_TABS);
    ...
    public Component buildFieldsInfo() {
        ...
        txtName.setRequired(true);
        txtName.setDescription(BundleUtils.getString("repairLaborMngt.list.name"));
        txtName.setCaption(BundleUtils.getString("repairLaborMngt.list.name"));
        txtName.setInputPrompt(BundleUtils.getString("repairLaborMngt.list.name"));
        ...
        txtLevel.setRequired(true);
        txtLevel.setDescription(BundleUtils.getString("repairLaborMngt.list.level"));
        txtLevel.setCaption(BundleUtils.getString("repairLaborMngt.list.level"));
        txtLevel.setInputPrompt(BundleUtils.getString("repairLaborMngt.list.level"));
        ...
        txtQuota.setRequired(true);
        txtQuota.setDescription(BundleUtils.getString("repairLaborMngt.list.quota"));
        txtQuota.setCaption(BundleUtils.getString("repairLaborMngt.list.quota"));
        txtQuota.setInputPrompt(BundleUtils.getString("repairLaborMngt.list.quota"));

        txtDecreaseLevel = new TextField();
        txtDecreaseLevel.setImmediate(true);
        txtDecreaseLevel.setRequired(true);
        txtDecreaseLevel.setWidth("100.0%");
        txtDecreaseLevel.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        txtDecreaseLevel.setRequired(true);
        txtDecreaseLevel.setDescription(BundleUtils.getString("repairLaborMngt.list.decreaseLevel"));
        txtDecreaseLevel.setCaption(BundleUtils.getString("repairLaborMngt.list.decreaseLevel"));
        txtDecreaseLevel.setInputPrompt(BundleUtils.getString("repairLaborMngt.list.decreaseLevel"));
        ...
        cmbParent.setCaption(BundleUtils.getString("repairLaborMngt.list.parent"));
        ...
        details.addComponent(txtDecreaseLevel);
