 ...
 */
public class Maintenance2MngtController {

    Maintenance2MngtView view;
    MaintenanceMngtService service;

    CustomGrid pagedTable;
//    String[] headerName = new String[]{"Id", "Username", "Email", "Phone", ""};
    String prefix = "maintenance2Mngt.list";//tien to trong file language
    String headerKey = "header.maintenance2Mngt";//lay trong file cas
    ...
    String jobListLabel = "maintenance2Mngt.list";
    Resource resource;

    public Maintenance2MngtController(Maintenance2MngtView view) {
        this.view = view;
        this.pagedTable = view.getPagedTable();
        initTable(MaintenanceMngtService.getInstance().listMaintenancesByType("2"));
        doAction();
    }
...
//        container.addContainerProperty("stt", String.class, null);
    ...
    public boolean validateData(Maintenance2MngtUI ui) {
...
//        }
    ...
    private void initDataDialog(Maintenance2MngtUI ui, boolean isInsert, Maintenance dto) {
...
//        ui.getTxtUnit().focus();
    ...
    private void getDataFromUI(Maintenance2MngtUI ui, Maintenance dto) {
