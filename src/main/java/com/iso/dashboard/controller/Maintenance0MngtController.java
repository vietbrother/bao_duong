 ...
 */
public class Maintenance0MngtController {

    Maintenance0MngtView view;
    MaintenanceMngtService service;

    CustomGrid pagedTable;
//    String[] headerName = new String[]{"Id", "Username", "Email", "Phone", ""};
    String prefix = "maintenance0Mngt.list";//tien to trong file language
    String headerKey = "header.maintenance0Mngt";//lay trong file cas
    ...
    String jobListLabel = "maintenance0Mngt.list";
    Resource resource;

    public Maintenance0MngtController(Maintenance0MngtView view) {
        this.view = view;
        this.pagedTable = view.getPagedTable();
        initTable(MaintenanceMngtService.getInstance().listMaintenancesByType("0"));
        doAction();
    }
...
//        container.addContainerProperty("stt", String.class, null);
    ...
    public boolean validateData(Maintenance0MngtUI ui) {
...
//        }
    ...
    private void initDataDialog(Maintenance0MngtUI ui, boolean isInsert, Maintenance dto) {
...
//        ui.getTxtUnit().focus();
    ...
    private void getDataFromUI(Maintenance0MngtUI ui, Maintenance dto) {
