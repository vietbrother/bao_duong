 ...
 *
 */
public class UploaderAvatar extends CustomComponent {

    Logger log = Logger.getLogger(UploaderAvatar.class);
    ...
    String extensionAllow = ".jpg,.gif,.jpeg,.png,.bmp";
    ...
    public UploaderAvatar(String caption) {
...
//        upload.addListener(uploader);
    ...
    public UploaderAvatar(Date date) {
    ...
    public UploaderAvatar(String pathUpload, String avatarPath) {
        ...
        addUpload(avatarPath);

    }

    private void addUpload(String avatarPath) {
        avatar = new Embedded();
            ...
            public void handleFile(InputStream inputStream, String fileName, String mimeType, long length, int filesLeftInQueue) {
                try {
                    ...
                    if (checkExtend) {
                        ...
                        String pathImg = prefixName + fileName;
...
//        multiUpload.setAcceptedMimeTypes(DataUtil.getListAcceptFile());
        ...
        multiUpload.getSmartUpload().setUploadButtonCaptions(BundleUtils.getString("profileMachine.list.avatarChange"), BundleUtils.getString("profileMachine.list.avatarChange"));
