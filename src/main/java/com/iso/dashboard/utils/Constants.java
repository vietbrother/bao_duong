...
public class Constants {
    ...
    public interface FILE_CONF {
        ...
        public static final String PATH_IMPORT_TEMPLATE_XLS = File.separator + "WEB-INF"
                + File.separator + "templates"
                + File.separator + "TEMPLATE_IMPORT.xls";
        public static final String PATH_IMPORT_TEMPLATE_XLSX = File.separator + "WEB-INF"
                + File.separator + "templates"
                + File.separator + "TEMPLATE_IMPORT.xlsx";
