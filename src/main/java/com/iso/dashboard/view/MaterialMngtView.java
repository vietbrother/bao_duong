...
import com.iso.dashboard.controller.MaterialMngtController;
 ...
 */
public class MaterialMngtView extends Panel implements View {
    ...
    public MaterialMngtView() {
        setSizeFull();
        addStyleName(ValoTheme.PANEL_BORDERLESS);
        setSizeFull();
        VerticalLayout root = new VerticalLayout();
        root.setCaption(BundleUtils.getStringCas("menu.materialMngt"));
        root.setSizeFull();
        ...
        new MaterialMngtController(this);
    }
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtMaterial.setImmediate(true);
        txtMaterial.setInputPrompt(BundleUtils.getString("assetMngt.list.name"));
        txtMaterial.setWidth("100.0%");
        txtMaterial.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        searchForm.addComponent(txtMaterial);
