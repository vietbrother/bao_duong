...
import com.iso.dashboard.controller.ProfileReferenceController;
 ...
 * @author VIET_BROTHER
 */
public class ProfileReferenceView extends TabSheet implements View {

    private Button btnAdd;

    private CustomPageTable pagedTable;
    private ProfileReferenceController controller;

    public ProfileReferenceView(String profileId) {
        setSizeFull();
        ...
        controller = new ProfileReferenceController(this, profileId);
    }
...
//        contenPanel.addComponent(titleLabel);
    ...
    public ProfileReferenceController getController() {
        return controller;
    }

    public void setController(ProfileReferenceController controller) {
