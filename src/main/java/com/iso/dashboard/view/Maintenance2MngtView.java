...
import com.iso.dashboard.controller.Maintenance2MngtController;
 ...
 */
public class Maintenance2MngtView extends Panel implements View {
    ...
    public Maintenance2MngtView() {
        setSizeFull();
        addStyleName(ValoTheme.PANEL_BORDERLESS);
        setSizeFull();
        VerticalLayout root = new VerticalLayout();
        // Hiển thị menu name theo type
        root.setCaption(BundleUtils.getStringCas("menu.maintenance2Mngt"));
        root.setSizeFull();
        ...
        new Maintenance2MngtController(this);
    }
