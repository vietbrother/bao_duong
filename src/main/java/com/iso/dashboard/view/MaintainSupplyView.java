...
import com.iso.dashboard.controller.MaintainSupplyController;
 ...
 */
public class MaintainSupplyView extends Panel implements View {
...
//        addComponent(buildToolbar());
        new MaintainSupplyController(this);
    }

    public MaintainSupplyView(int repairType) {
...
//            job.setUserName(i + "_native");
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtRepairLabor.setInputPrompt(BundleUtils.getString("maintainSub.list.name"));
