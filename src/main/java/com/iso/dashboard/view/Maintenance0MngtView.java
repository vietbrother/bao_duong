...
import com.iso.dashboard.controller.Maintenance0MngtController;
 ...
 */
public class Maintenance0MngtView extends Panel implements View {
    ...
    public Maintenance0MngtView() {
        setSizeFull();
        addStyleName(ValoTheme.PANEL_BORDERLESS);
        setSizeFull();
        VerticalLayout root = new VerticalLayout();
        // Hiển thị menu name theo type
        root.setCaption(BundleUtils.getStringCas("menu.maintenance0Mngt"));
        root.setSizeFull();
        ...
        new Maintenance0MngtController(this);
    }
