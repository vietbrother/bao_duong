 ...
 */
public class RepairTypeMngtView extends Panel implements View {

    private TextField txtRepairType;
    ...
    public List<RepairType> repairTypes = new ArrayList<>();

    public RepairTypeMngtView() {
        setSizeFull();
...
//        setSpacing(false);
        ...
        root.setCaption(BundleUtils.getStringCas("menu.repairTypeMngt"));
        root.setSizeFull();
...
//        addComponent(buildToolbar());
        new RepairTypeMngtController(this);
    }
...
//            job.setUserName(i + "_native");
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtRepairType = new TextField();
        txtRepairType.setImmediate(true);
        txtRepairType.setInputPrompt(BundleUtils.getString("repairTypeMngt.list.name"));
        txtRepairType.setWidth("100.0%");
        txtRepairType.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        searchForm.addComponent(txtRepairType);
    ...
    public TextField getTxtRepairType() {
        return txtRepairType;
    }

    public void setTxtRepairType(TextField txtRepairType) {
        this.txtRepairType = txtRepairType;
    }
